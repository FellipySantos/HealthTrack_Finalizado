...
<title>Consulta de Pressão</title>
...
<%@ include file="menu.jsp" %>
	<div class="container">
	    <br>
		<center><h1>Consulta de Pressão</h1></center>
			...
			<c:forEach items="${pressao}" var="p">
				<tr>
					...
					<td>
						...
						<button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#excluirModal" onclick="codigoExcluir.value = ${p.codigoPressao}">
  							Excluir
						</button>
					</td>
				</tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        		Deseja realmente excluir essa pressão?
      </div>
