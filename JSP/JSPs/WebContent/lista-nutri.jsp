...
<title>Consulta de Nutricionista</title>
...
<%@ include file="menu.jsp" %>
	<div class="container">
	    <br>
		<center><h1>Consulta de Nutricionista</h1></center>
		<br>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        		Deseja realmente excluir esse Nutricionista?
      </div>
