...
<div class="container">
    <br>
	<h1><center>Cadastro de Treinador</center></h1>
	...
	<form action="treinador" method="post">
		...
		<div class="form-group">
			...
			<input type="text" name="cnpj" id="id-cnpj" class="form-control" placeholder="999.999.999/9999-99">
		</div>
		<div class="form-group">
			<label for="id-cref">CREF</label>
			<input type="text" name="cref" id="id-cref" class="form-control" placeholder="009999-G/SP">
		</div>
