...
<div class="container">
    <br>
	<h1><center>Cadastro de Treino</center></h1>
	...
	<form action="treino" method="post">
		...
		<div class="form-group">
			...
			<input type="text" name="descricao" id="id-descricao" class="form-control"  placeholder="Digite uma descrição">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" name="frequencia" id="id-frequencia" class="form-control"  placeholder="Digite uma frequência">
		</div>
		<br>
