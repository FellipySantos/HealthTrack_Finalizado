...
<title>Consulta de Atleta</title>
...
<%@ include file="menu.jsp" %>
	<div class="container">
	    <br>
		<center><h1>Consulta de Atleta</h1></center>
		<br>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        		Deseja realmente excluir esse atleta?
      </div>
